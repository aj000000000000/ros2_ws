...
class TurtleNavigationNode(Node):
    def __init__(self):
        ...
        self.goal_poses = [  # Define goal positions and orientations
            {'x': 0.18900367617607117, 'y': -1.2682498693466187, 'yaw': 0},
            {'x': 0.7723745703697205, 'y': -3.4390316009521484, 'yaw': 0},
            {'x': 4.960168361663818, 'y': -1.019132137298584, 'yaw': 0},
            {'x': 2.42461895942688, 'y': -3.8326966762542725, 'yaw': 0}
        ]
